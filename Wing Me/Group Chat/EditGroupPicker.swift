...
extension EditGroupVC: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        imageView.image = resizeImage(image: image, pixel: 600)
    ...
    func createBody(with parameters: [String: Any], boundary: String) throws -> Data {
        ...
        if let image = imageView.image, let data = image.jpegData(compressionQuality: 0.5) {
            ...
            body.append("--\(boundary)\r\n")
            body.append("Content-Disposition: form-data; name=\"main_image\"; filename=\"main_image.jpeg\"\r\n")
